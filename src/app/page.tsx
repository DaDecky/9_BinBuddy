    ...
    <main className="flex flex-col items-center justify-center min-h-screen font-inter sm:w-100 lg:w-100">
      <div className="relative w-full flex flex-col items-center text-white justify-center bg-cover bg-center bg-no-repeat min-h-screen" style={{ backgroundImage: "url('/bg_home.jpeg')" }}>
        ...
        <div className="relative text-center p-8 w-full max-w-8xl mx-auto">
          <h1 className="text-4xl md:text-8xl font-bold mb-4">Waste bin MAP locations and recycling</h1>
      ...
      <div className="w-full bg-blue-300 p-8 text-green-600" style={{backgroundColor:"#F1F5FF"}}>
        <div className="text-left w-full max-w-9xl mx-auto">
          <h2 className="text-4xl sm:text-4xl md:text-7xl font-bold mb-8">Featured Articles</h2>
          <div className="container" style={{ maxWidth: "600px", marginBottom: "20px" }}>
            ...
            <h2 className="text-2xl sm:text-xl md:text-3xl font-bold mt-4 mb-6" style={{ marginBottom: "10px" }}>Pengelolaan Sampah di Indonesia</h2>
            <p className="text-lg sm:text-sm md:text-xl mb-4">Persoalan sampah di Indonesia menjadi tantangan yang berat di masa depan mengingat terbatasnya jumlah TPA berikut daya tampungnya. Apalagi pada tahun 2030, ... 
            </p>
            <Link href="/explore/article">
              <p className="text-base sm:text-sm md:text-lg mb-4 underline">Read more</p>
            </Link>
          </div>
          <div className="container" style={{ maxWidth: "600px", marginBottom: "20px" }}>
            ...
            <h2 className="text-2xl sm:text-xl md:text-3xl font-bold mt-4 mb-6" style={{ marginBottom: "10px" }}>The Benefits of Recycling</h2>
            <p className="text-lg sm:text-sm md:text-xl mb-4">Recycle atau daur ulang adalah proses pengumpulan dan pemrosesan bahan yang seharusnya dibuang sebagai limbah dan mengubahnya menjadi produk baru. Recycle termasuk ... 
            </p>
            <Link href="/explore/article2">
              <p className="text-base sm:text-sm md:text-lg mb-4 underline">Read more</p>
            </Link>
      ...
      <div className="w-full bg-white p-8 text-green-600">
        <div className="text-left w-full max-w-9xl mx-auto">
          <h2 className="text-4xl sm:text-4xl md:text-7xl font-bold mb-10">Public Waste Disposal Education</h2>
          <div className="mb-9">
            <h3 className="text-2xl sm:text-2xl md:text-4xl font-lg leading-normal">Learn about waste recycling and proper disposal methods</h3>
      ...
      <div className="w-full bg-green-200 p-8 text-green-600">
        <div className="flex flex-col justify-center mt-10 max-w-6xl mx-auto bg-white py-10 px-4 md:px-40">
          <div className="flex flex-col text-left w-full max-w-6xl mx-auto">
            <h3 className="text-2xl sm:text-2xl md:text-4xl font-bold sm:mb-3 md:mb-6">Map of Waste Bin Locations</h3>
            <div className="mb-6">
              <p className="text-base sm:text-sm md:text-lg font-lg leading-normal">Find nearby waste bins and learn how to dispose of waste correctly.</p>
            </div>
          </div>
