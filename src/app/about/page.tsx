...
const Page = () => {
  ...
  return (
    <div className="bg-[#E7F0DC] p-4 min-h-screen">
      <div className="text-center">
        <h1 className="text-xl font-bold text-green-700 font-inter text-center mb-10">
          {" "}
          About Us{" "}
        </h1>
        <section className="text-m text-green-700 font-inter text-center mb-7">
          <p className="mb-7">
            <span className="font-bold">Bin Buddy</span> is an application that
            functions as a trash can locator around Institut Teknologi Bandung
            {"'"}s Ganesha Campus area to help students keep the surroundings
            clean.
          </p>

          <p>
            <span className="font-bold">Bin Buddy</span> is created by a group
            of students trying to take care of their own environment while also
        ...
        <section className="text-m text-green-700 font-inter text-center mb-5">
          ...
          <p className="mb-5">
            Our team consists of 4 different units each with their own
            expertise.
          </p>
          ...
          <div className="flex flex-col items-center">
            ...
            {showSoftDev && (
              <div className="mb-4 flex flex-col items-center">
                <button onClick={DickyClick} className="text-m mb-3 block">
                  Muhammad Dicky Isra
                </button>

                {showDicky && (
                  <img
                    src="/Photos/Dicky.jpg"
                    alt="Dicky"
                ...
                <button onClick={SharonClick} className="text-m mb-3 block">
                  Sharon Darma Putra
                </button>

                {showSharon && (
                  <img
                    src="/Photos/Sharon.jpg"
                    alt="Sharon"
                    style={{ width: "400px", height: "500px" }}
                    className="rounded-full"
                  ></img>
                ...
                <button onClick={FilbertClick} className="text-m mb-3 block">
                  Filbert Engyo
                </button>

                {showFilbert && (
                  <img
                    src="/Photos/Filbert.jpg"
                    alt="Filbert"
                    style={{ width: "400px", height: "500px" }}
                    className="rounded-full"
                  ></img>
                ...
                <button onClick={TimurClick} className="text-m mb-3 block">
                  Muhammad Timur Kanigara
                </button>

                {showTimur && (
                  <img
                    src="/Photos/Timur.jpg"
                    alt="Timur"
                ...
                <button onClick={KennethClick} className="text-m mb-3 block">
                  Kenneth Ricardo Chandra
                </button>

                {showKenneth && (
                  <img
                    src="/Photos/Kenneth.jpg"
                    alt="Kenneth"
                    style={{ width: "400px", height: "500px" }}
                    className="rounded-full"
                  ></img>
            ...
            <button onClick={UIUXClick} className="font-bold text-l mb-3 block">
              UI/UX
            </button>

            {showUIUX && (
              <div className="mb-4 flex flex-col items-center">
                <button onClick={NelsonClick} className="text-m mb-3 block">
                  Benedict Nelson
                </button>

                {showNelson && (
                  <img
                    src="/Photos/Nelson.jpg"
                    alt="Nelson"
                    style={{ width: "400px", height: "500px" }}
                    className="rounded-full"
                  ></img>
            ...
            {showDatSci && (
              <div className="mb-4 flex flex-col items-center">
                <button onClick={AlbertClick} className="text-m mb-3 block">
                  Albertus Christian Poandy
                </button>

                {showAlbert && (
                  <img
                    src="/Photos/Albert.jpg"
                    alt="Albert"
                    style={{ width: "400px", height: "400px" }}
                    className="rounded-full"
                  ></img>
                ...
                <button onClick={AlmaClick} className="text-m mb-3 block">
                ...
                <button onClick={AudyClick} className="text-m mb-3 block">
            ...
            {showProdMan && (
              <div className="mb-4 flex flex-col items-center">
                <button onClick={VandegaClick} className="text-m mb-3 block">
                  Vandega Arozan Musholine
                </button>

                {showVandega && (
                  <img
                    src="/Photos/Vandega.jpg"
                    alt="Vandega"
                    style={{ width: "400px", height: "500px" }}
                    className="rounded-full"
                  ></img>
                ...
                <button onClick={IndanaClick} className="text-m mb-3 block">
                  Indana Aulia Ayundazulfa
                </button>

                {showIndana && (
                  <img
                    src="/Photos/Indana.jpg"
                    alt="Indana"
                    style={{ width: "400px", height: "400px" }}
                    className="rounded-full"
                  ></img>
        ...
        <p className="text-m text-green-700 font-inter text-center ">
          <span className="font-bold">Contact Us</span> at{" "}
          <a
            href="mailto:binbuddyitb@gmail.com"
            className="font-bold text-green-700 underline"
          >
            binbuddyitb@gmail.com
          </a>
        </p>
      </div>
    </div>
